...
<body>
	 ...
	 <form action = "register" method = "post">
		...
		<div class="alert-danger"><?php echo e($errors->first('firstName')); ?></div>
		<?php endif; ?>
		<br>
		<input type="text" name="lastName" placeholder="Last Name">
		<?php if($errors->first('lastName')): ?>
		<div class="alert-danger"><?php echo e($errors->first('lastName')); ?></div>
		<?php endif; ?>
		<br>
...
</html><?php /**PATH C:\Users\Alexv\Documents\1.LaravelWorkspace\MilestonePHP3\resources\views/register.blade.php ENDPATH**/ ?>